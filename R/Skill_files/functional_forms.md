...
- [ ] Additional behaviour: For categorical variables that have been dummied, the centering will be applied to each
...
**Details:**
- [ ] Reference level handling: *(specify default — first level, most common, or manual?)*
- [ ] Should drop reference level column: *(yes / no?)*
- [ ] Factor vs character input handling: *(add here)*
- [ ] Additional behaviour: *(add here)*
...
- [variables-sheet-utils.R](variables-sheet-utils.R) — original sheet-dependent utilities
- [transformation-type.R](transformation-type.R) — transformation type logic
- [create-study-data.R](create-study-data.R) — downstream consumer of transformed data
