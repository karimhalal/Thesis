#' @title Standardized Daily opiate/bzd equivalents conversion function
#'
#' @description This function creates a derived variable for average daily milligram 
#' morphine equivalents (MEQ) and diazepam equivalents (DME) for perscriptions in NMS. 
#' 
...
#' 
#' DME is a standardized measure of benzodiazepine content allowing for direct comparisons of potency
#' between drugs of different strength and formulations. This is done through conversion of drug dose
#' into its equivalent diazepam content (in milligrams).
#' 
#' This function only applies to drugs with oral routes of administration including capsules, tablets, 
#' 
#'
...
#' in NMS dataset to its corresponding characteristics in DIN_list.
#' 
